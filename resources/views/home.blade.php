...
<body>
    ...
    <section>
        <div>
            <h1 class="category_title"><i class="fas fa-cloud" style="color: #232323;"></i> My Day</h1>
            @if (count($my_days) > 0)    
                @foreach ($my_days as $my_day)
                    <div class="todo_wrapper">
                        ...
                        <div style="margin-right: 10px; display: flex; align-items: center;">
                            <a style="background: none; border: none; cursor: pointer;" href="{{ route("exact-my-day", $my_day -> id) }}"><i class="far fa-edit" style="color: #232323; font-size: 18px; margin: 0 10px 0 0;"></i></a>
            ...
            @if (count($done_my_days) > 0)
                <div>
                    <div style="display: flex; padding: 5px; width: 115px; cursor: pointer; border-radius: 5px; background: #232323; margin: 0 0 10px 0;" class="Done_Myday_Controller">
