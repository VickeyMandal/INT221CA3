...
<body>
    ...
    <section>
        <div>
            <h1 class="category_title"><i class="fas fa-sun" style="color: #232323;"></i> Tasks</h1>
            @if (count($tasks) > 0)    
                @foreach ($tasks as $task)
                    <div class="todo_wrapper">
                        ...
                        <div style="margin-right: 10px; display: flex; align-items: center;">
                            <a style="background: none; border: none; cursor: pointer;" href="{{ route("exact-tasks", $task -> id) }}"><i class="far fa-edit" style="color: #232323; font-size: 18px; margin: 0 10px 0 0;"></i></a>
