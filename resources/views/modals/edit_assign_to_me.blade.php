...
<body>
    ...
    <section>
        <div>
            <h1 class="category_title"><i class="fas fa-sun"></i> Assigned to me</h1>
                ...
                @foreach ($assigned_to_mes as $assigned_to_me)
                    <div class="todo_wrapper">
                        ...
                        <div style="margin-right: 10px; display: flex; align-items: center;">
                            <a style="background: none; border: none; cursor: pointer;" href="{{ route("exact_assigned_to_me", $assigned_to_me -> id) }}"><i class="far fa-edit" style="color: #2a9d8f; font-size: 18px; margin: 0 10px 0 0;"></i></a>
    ...
    <div class="edit_modal_wrapper">
        <div class="edit_modal">
            <form action="{{ route("update_assigned_to_me", $exact_assigned_to_me->id) }}" method="POST">
                <div class="description_block">
                    <input type="text" value="{{ $exact_assigned_to_me->description }}" name="description">
                </div>
                <div class="button_block">
                    @method("PUT")
                    @csrf
                    <input type="submit" value="Update">
                    <a href="/assign-to-me">Close</a>
                </div>
            </form>
        </div>
        <div class="created_date">
            <p>Create on {{ $exact_assigned_to_me -> created_at }}</p>
            <form action="{{ route("delete_assigned_to_me", $exact_assigned_to_me->id) }}" method="GET">
